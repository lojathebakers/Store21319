...
var TJPzoomwidth 		= 260;              //zoom window size
...
var TJPbordercolor = '#f4f4f4';      //border color

var TJPshadowthick 	= 8;              //shadow image size/2, SET 0 to have no shadows (saves cpu)
var TJPshadow 		= '../lojas/00004647/images/dropshadow/';       // <>: n, ne, e, se, s, sw, w, nw - TJPshadow+'nw.png'
